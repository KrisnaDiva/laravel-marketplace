        ...
        <div class="col-11 shadow mt-3 p-5">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="my-form">
                ...
                <div class="mb-3">
                    ...
                    <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="" required>
                    @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="stock" type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" value="" required>
                    @error('stock')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
